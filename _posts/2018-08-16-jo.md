...
Just browse to [https://localhost:8080/](https://localhost:8080/) once the container is running.
...
Clicking the button "Get me a Chuck joke!" will fetch a Chuck Norris joke from [https://api.chucknorris.io/](https://api.chucknorris.io/) for us.
