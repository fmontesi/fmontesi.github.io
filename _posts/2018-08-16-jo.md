...
[Jo](https://github.com/fmontesi/jo) makes it easy to interact with these services from webpages.
...
I'm going to use some [Jolie](https://www.jolie-lang.org/) language, because it makes things very simple for the purposes of this tutorial. You do not need to know Jolie to read what follows: the code is simple enough to be explained on the fly.
...
Just browse to https://localhost:8080/ once the container is running.
...
There's an API for that: https://api.chucknorris.io/. (If you didn't know about this, reading this tutorial might be worth it just for getting that link now...)
For example, to search for a joke containing the word "computer", we just invoke https://api.chucknorris.io/jokes/search?query=computer.
...
<head>
	<script type="text/javascript"
		src="https://cdn.rawgit.com/fmontesi/jo/master/lib/jo.js"></script>
	<script
...
Clicking the button "Get me a Chuck joke!" will fetch a Chuck Norris joke from https://api.chucknorris.io/ for us.
